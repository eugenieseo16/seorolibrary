...
CREATE TABLE `PlacePhoto` (
  `placePhotoId` bigint(20) NOT NULL AUTO_INCREMENT,
  `photo` varchar(255) DEFAULT NULL,
  `placeId` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`placePhotoId`),
  KEY `FKqs7rbib9bn53jitvijgymsm2r` (`placeId`),
  CONSTRAINT `FKqs7rbib9bn53jitvijgymsm2r` FOREIGN KEY (`placeId`) REFERENCES `Place` (`placeId`)
