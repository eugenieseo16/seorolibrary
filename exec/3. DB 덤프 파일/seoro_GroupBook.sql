...
CREATE TABLE `GroupBook` (
  `groupBookId` bigint(20) NOT NULL AUTO_INCREMENT,
  `bookImage` varchar(255) DEFAULT NULL,
  `bookTitle` varchar(255) DEFAULT NULL,
  `isbn` varchar(255) DEFAULT NULL,
  `groupId` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`groupBookId`),
  KEY `FK88qr30jbhyipwrg86xhllrob1` (`groupId`),
  CONSTRAINT `FK88qr30jbhyipwrg86xhllrob1` FOREIGN KEY (`groupId`) REFERENCES `Groups` (`groupId`)
