...
CREATE TABLE `ReadBook` (
  `readBookId` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  KEY `FKmwe3rv47r31iqt5be8ag3xw03` (`memberId`),
  CONSTRAINT `FKmwe3rv47r31iqt5be8ag3xw03` FOREIGN KEY (`memberId`) REFERENCES `Member` (`memberId`)
