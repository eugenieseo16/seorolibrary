...
CREATE TABLE `Evaluation` (
  ...
  `rentBookId` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`evaluationId`),
  KEY `FKmt3rm1ob5pw28v6a3stjqkrvh` (`rentBookId`),
  CONSTRAINT `FKmt3rm1ob5pw28v6a3stjqkrvh` FOREIGN KEY (`rentBookId`) REFERENCES `RentBook` (`rendBookId`)
