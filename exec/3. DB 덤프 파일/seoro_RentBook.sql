...
CREATE TABLE `RentBook` (
  `rendBookId` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`rendBookId`),
  KEY `FKft3creobc0hhcuu6f3dxivts6` (`chatRoomId`),
  CONSTRAINT `FKft3creobc0hhcuu6f3dxivts6` FOREIGN KEY (`chatRoomId`) REFERENCES `ChatRoom` (`chatRoomId`)
