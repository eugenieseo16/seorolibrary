...
CREATE TABLE `GroupJoin` (
  `groupJoinId` bigint(20) NOT NULL AUTO_INCREMENT,
  `groupId` bigint(20) DEFAULT NULL,
  `memberId` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`groupJoinId`),
  KEY `FKnlfr3esh4ds95cg3d82qhi1no` (`groupId`),
  KEY `FKdjnvdrti13g6h7aufa6inge8u` (`memberId`),
  CONSTRAINT `FKdjnvdrti13g6h7aufa6inge8u` FOREIGN KEY (`memberId`) REFERENCES `Member` (`memberId`),
  CONSTRAINT `FKnlfr3esh4ds95cg3d82qhi1no` FOREIGN KEY (`groupId`) REFERENCES `Groups` (`groupId`)
